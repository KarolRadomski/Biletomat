    ...
    <div class="pageContainer">
      ...
      <div class="basicInfo">
        ...
        <div class="d-flex dateTimeContainer">
          <div class="form-floating mb-3">
            <input type="date" class="form-control w-100" id="eventDate" v-model="tempDate" @change="translateDate('date')" placeholder="23-12-322" />
            <label for="eventDate">Data wydarzenia</label>
          </div>
          <div class="form-floating d-flex mb-3 timeContainer">
            <input type="time" class="form-control w-100" id="eventTime" v-model="tempTime" @change="translateDate('date')" placeholder="23-12-322" />
            <label for="eventTime">Godzina</label>
          </div>
        </div>
        <!-- Miejsce -->
        <div class="form-floating mb-3">
          <select class="form-select w-50" id="floatingSelect" v-model="Event.event.placeID" @change="handleChangePlace()" aria-label="Floating label select example" disabled>
