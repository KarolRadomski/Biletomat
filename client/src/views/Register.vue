  ...
  <section class="background text-center text-lg-start">
    ...
    <div class="pt-3 ms-4">
      <router-link :to="{ path: '/' }" style="text-decoration: none">
        <h5 class="returnButton">
          <i class="bi bi-reply-fill me-2" style="font-size: 30px; position: relative; top: 1px"></i>Powrót do strony głównej
        </h5>
      </router-link>
    </div>
    <div class="container py-4">
      <div class="row g-0 align-items-center pt-4">
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <div class="card cascading-right loginCard">
            <div class="card-body p-5 shadow-5">
              ...
              <h6 class="fw-bold mb-5 text-center">i kupuj bilety już teraz</h6>
                ...
                <div class="col-md-6 mb-2">
                  <div class="form-outline">
                    ...
                    <input
                      ...
                      placeholder="Jan"
                      class="form-control"
                      :class="validateForm.fname.validClass"
                    />
                  </div>
                </div>
                <!-- Last name input -->
                <div class="col-md-6 mb-2">
                  <div class="form-outline">
                    ...
                    <input
                      ...
                      placeholder="Nowak"
                      class="form-control"
                      :class="validateForm.lname.validClass"
                    />
                  </div>
                </div>
              </div>
              ...
              <div class="form-outline mb-2">
                ...
                <input
                  ...
                  class="form-control"
                  :class="validateForm.email.validClass"
                />
              </div>
              ...
              <div class="form-outline mb-1">
                ...
                <input
                  ...
                  placeholder="**********"
                  class="form-control"
                  :class="validateForm.password.validClass"
                />
              </div>
              ...
              <div class="form-outline mb-1">
                ...
                <input
                  ...
                  placeholder="**********"
                  class="form-control"
                  :class="validateForm.password2.validClass"
                />
              </div>
        ...
        <div class="col-lg-6 mb-5 mb-lg-0 loginPicture">
          <img src="../assets/loginPicture.png" class="w-100 rounded-4 shadow-4" alt="" />
        </div>
      </div>
    </div>
    <!-- Jumbotron -->
...
export default {
  ...
  methods: {
    ...
    async handleRegister() {
      ...
      if (
        this.form.email.validClass &&
        this.form.fname.validClass &&
        this.form.lname.validClass &&
        this.form.password.validClass &&
        this.form.password2.validClass
      ) {
        ...
        if (formCopy[key].value === '') formCopy[key].validClass = '';
          ...
          switch (key) {
            case 'email':
              ...
              break;
            case 'fname':
              formCopy[key].value.length >= 3 && formCopy[key].value.length < 30
                ? (formCopy[key].validClass = 'is-valid')
                : (formCopy[key].validClass = 'is-invalid');
              break;
            case 'lname':
            ...
            case 'password':
              ...
              break;
            case 'password2':
              formCopy[key].value === formCopy['password'].value
                ? (formCopy[key].validClass = 'is-valid')
                : (formCopy[key].validClass = 'is-invalid');
              break;
          }
